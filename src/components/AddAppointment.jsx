...
const AddAppointment = ({onSendAppointment, lastId}) =>{
    /**
     * Widget for adding a new appointment
     */
    ...
    function formDataPublish(){
        ...
        // Updating the list of appointments in the parent componenet
        onSendAppointment(appointmentInfo)
        // Reseting the form in current component
   ...
   return (
    <div>
        ...
        {
            //Display component if the toggle is true
            toggleForm &&
